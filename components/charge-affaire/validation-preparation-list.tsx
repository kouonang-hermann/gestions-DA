                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      ...
                      <Badge className="bg-purple-500 text-white text-xs whitespace-normal break-words max-w-full">{demande.status}</Badge>
                    ...
                    {demande.sortieAppro?.commentaire && (
                      <p className="text-xs sm:text-sm text-purple-600 bg-purple-50 p-2 rounded truncate">
                        <strong>Commentaire:</strong> {demande.sortieAppro.commentaire}
                      </p>
                    )}
                  </div>
