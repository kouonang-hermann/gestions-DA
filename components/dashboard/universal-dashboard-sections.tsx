...
export default function UniversalDashboardSections({ userRole, title }: UniversalDashboardSectionsProps) {
  ...
  const getStatusColor = (status: string) => {
    const colors = {
      ...
      "en_attente_validation_logistique": "bg-orange-100 text-orange-800",
      ...
      "en_attente_validation_livreur": "bg-teal-100 text-teal-800",
  ...
  const getStatusLabel = (status: string) => {
    const labels = {
      ...
      "en_attente_validation_livreur": "En attente livreur",
