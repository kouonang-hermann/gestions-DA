...
const statusColors: Record<DemandeStatus, string> = {
  ...
  en_attente_preparation_logistique: "bg-purple-500",
  en_attente_validation_logistique_finale: "bg-orange-500",
...
const statusLabels: Record<DemandeStatus, string> = {
  ...
  en_attente_preparation_logistique: "À préparer (Logistique)",
  en_attente_validation_logistique_finale: "Validation finale logistique",
